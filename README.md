# MagicTower (魔塔v1.0——zzf版) (Java 实现)
...
本人最早于 2024年11月11日，心血来潮想用写一个游戏来玩，在网上找到了这个版本，决定在此版本基础上进行修改。

**注：**

- **项目下的 [ 魔塔V1.12.swf ] 为游戏最初原作品**
- **项目下的 [ 开始游戏-原作者版.jar ] 为上一个作者改为java版本的仿制作品（ 目前仅支持分辨率 1920 * 1080 以上的显示器 ）**
